...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* MIDI Service service */
    {
        0x000Cu, /* Handle of the MIDI Service service */ 
        {

            /* MIDI IO Charateristic characteristic */
            {
                0x000Eu, /* Handle of the MIDI IO Charateristic characteristic */ 
