...
reg32 * CapSense_pcTable[] = {
    (reg32 *)CapSense_Sns__Note1__BTN__PC, 
    (reg32 *)CapSense_Sns__Note2__BTN__PC, 
    (reg32 *)CapSense_Sns__Note3__BTN__PC, 
    (reg32 *)CapSense_Sns__Note4__BTN__PC, 
    (reg32 *)CapSense_Sns__Note5__BTN__PC, 
};

const uint8 CapSense_portTable[] = {
    CapSense_Sns__Note1__BTN__PORT, 
    CapSense_Sns__Note2__BTN__PORT, 
    CapSense_Sns__Note3__BTN__PORT, 
    CapSense_Sns__Note4__BTN__PORT, 
    CapSense_Sns__Note5__BTN__PORT, 
};

const uint32 CapSense_maskTable[] = {
    CapSense_Sns__Note1__BTN__MASK, 
    CapSense_Sns__Note2__BTN__MASK, 
    CapSense_Sns__Note3__BTN__MASK, 
    CapSense_Sns__Note4__BTN__MASK, 
    CapSense_Sns__Note5__BTN__MASK, 
};

const uint8 CapSense_pinShiftTbl[] = {
    (uint8) CapSense_Sns__Note1__BTN__SHIFT, 
    (uint8) CapSense_Sns__Note2__BTN__SHIFT, 
    (uint8) CapSense_Sns__Note3__BTN__SHIFT, 
    (uint8) CapSense_Sns__Note4__BTN__SHIFT, 
    (uint8) CapSense_Sns__Note5__BTN__SHIFT, 
};
