...
#define CYBLE_MIDI_SERVICE_SERVICE_INDEX   (0x00u) /* Index of MIDI Service service in the cyBle_customs array */
#define CYBLE_MIDI_SERVICE_MIDI_IO_CHARATERISTIC_CHAR_INDEX   (0x00u) /* Index of MIDI IO Charateristic characteristic */
#define CYBLE_MIDI_SERVICE_MIDI_IO_CHARATERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_MIDI_SERVICE_SERVICE_HANDLE   (0x000Cu) /* Handle of MIDI Service service */
#define CYBLE_MIDI_SERVICE_MIDI_IO_CHARATERISTIC_DECL_HANDLE   (0x000Du) /* Handle of MIDI IO Charateristic characteristic declaration */
#define CYBLE_MIDI_SERVICE_MIDI_IO_CHARATERISTIC_CHAR_HANDLE   (0x000Eu) /* Handle of MIDI IO Charateristic characteristic */
#define CYBLE_MIDI_SERVICE_MIDI_IO_CHARATERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
